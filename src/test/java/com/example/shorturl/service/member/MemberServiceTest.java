...
class MemberServiceTest {
    ...
    void 회원가입() {
        //given
        MemberRequestDto.Create member = new MemberRequestDto.Create();
        ...
        //then
        Assertions.assertThat(saveMember.getEmail()).isEqualTo(member.getEmail());
        Assertions.assertThat(saveMember.getPassword()).isEqualTo(passwordEncoder.encode(member.getPassword()));
